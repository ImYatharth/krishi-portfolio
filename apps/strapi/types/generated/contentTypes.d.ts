...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Artist bio and about page content';
    displayName: 'About';
    pluralName: 'abouts';
    singularName: 'about';
  };
...
export interface ApiArtworkArtwork extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Individual artwork pieces';
    displayName: 'Artwork';
    pluralName: 'artworks';
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Artwork categories';
...
export interface ApiContactSubmissionContactSubmission
  ...
  attributes: {
    ...
    inquiryType: Schema.Attribute.Enumeration<
      ['commission', 'collaboration', 'print-purchase', 'general']
    > &
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutPreviewText: Schema.Attribute.Text &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 300;
      }>;
    createdAt: Schema.Attribute.DateTime;
    ...
    featuredArtworks: Schema.Attribute.Relation<
      'oneToMany',
      'api::artwork.artwork'
    >;
